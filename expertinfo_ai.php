...
<head>
	...
	<title>AI Adoption Scenario Study</title>
	<meta name="viewport" 
...
<h4> Complete the checklist to determine if you are a suitable participant.</h4>
	...
	<form name="expertinfo" action="writeexpertdata_ai.php" method="post">
	<div class="form-control">
        <table>
        	<tr><td><b>Check all that apply to you</b></td><td>  </td></tr>
	        <tr><td>I have worked in the AI sector for 5 or more years</td> 
			    <td><input type="hidden" name="yrs" value="0" > <input type="checkbox" name="yrs" value="Y" >  </td></tr>
            <tr><td>I have authored a book, published an article, or presented at a conference in the AI field<br></td>
				<td><input type="hidden" name="auth" value = "0"><input type="checkbox" name="auth" value = "Y"> </td></tr>
            <tr><td>I have been invited to speak at an event in the AI field (in the last 3 years)<br></td>
				<td><input type="hidden" name="event" value = "0"><input type="checkbox" name="event" value = "Y"> </td></tr>
			<tr><td>I have been the leader of a corporate team in the AI field</td>
				<td><input type="hidden" name="corp" value="0"><input type="checkbox" name="corp" value="Y"> </td></tr>
  			<tr><td>I am actively involved in AI policy making and decisions</td>
				<td><input type="hidden" name="policy" value="0"> <input type="checkbox" name="policy" value="Y"> </td></tr>
			<tr><td>I am a member of a committee in the field of AI</td>
				<td><input type="hidden" name="comm" value="0"><input type="checkbox" name="comm" value="Y"> </td></tr>
			<tr><td>I am a point of contact for the media for AI matters</td>
